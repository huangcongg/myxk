...
class Expert extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('expert_id, path, realname, subject, desc, achieve, quote_text, email', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'reports' => array(self::HAS_MANY, 'Report', 'expert_id'),
			'reports1' => array(self::HAS_MANY, 'Report', 'realname'),
